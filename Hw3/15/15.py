...
for times in range(1000):
    ...
    # print W_lin_total
    # raw_input('pause')
# print 'average W_3:',W_lin_total[3]/1000


'''predict'''
W_lin_total = W_lin_total/1000
print 'average W_lin ', W_lin_total
...
print 'average error: ',float(total_error/1000)
